...
- Step 3 [Report]: List findings clearly. Group by "Critical Logic" vs "Minor Cleanup". Save the report to `docs/review/<num.name>.md`, and commit only this file. (num needs to be unique and sequential)