...
- **Idea to Plan**: Map concepts into actionable plan in `docs/plan/<num.name>.md`.
...
- Step 2 [Plan]: Define Project Phases and technical specs in `docs/plan/<num.name>.md`.
- Step 3 [Update]:  Reflect new architectural changes in `context.md`, and `design.md`.
- Step 3 [Atomize]: Generate the final Atomic Task List for the Builder, update in `docs/plan/<num.name>.md`.